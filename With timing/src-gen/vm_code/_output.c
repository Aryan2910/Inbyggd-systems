...
void _outputreaction_function_0(void* instance_args) {
    ...
    #line 8 "/h/dk/f/ar4013si-s/Inbyggd%20systems/Lab-2/vm_extra.lf"
    printf("[OUTPUT] Got a can of %d\n",beverage->value);
#line 15 "/h/dk/f/ar4013si-s/Inbyggd systems/Lab-2/src-gen/vm_code/_output.c"
}
...
void _outputreaction_function_1(void* instance_args) {
    ...
    #line 12 "/h/dk/f/ar4013si-s/Inbyggd%20systems/Lab-2/vm_extra.lf"
    printf("[OUTPUT] Got the coin back.\n");
#line 25 "/h/dk/f/ar4013si-s/Inbyggd systems/Lab-2/src-gen/vm_code/_output.c"
}
#include "include/api/set_undef.h"
